...
# CMD yarn workspace hsb-gatekeeper prod -s | tail -n +3 | pino-sentry --dsn=$SENTRY_DSN --serverName="gatekeeper-$BALENA_DEVICE_UUID"
CMD yarn workspace hsb-gatekeeper prod -s
