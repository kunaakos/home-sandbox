...
CMD yarn workspace hsb-things knex migrate:latest && yarn workspace hsb-things serve -s | tail -n +3 | pino-sentry --dsn=$SENTRY_DSN --serverName="things-$BALENA_DEVICE_UUID"
