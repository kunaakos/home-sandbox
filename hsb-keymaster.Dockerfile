...
CMD yarn workspace hsb-keymaster knex migrate:latest && yarn workspace hsb-keymaster serve -s | tail -n +3 | pino-sentry --dsn=$SENTRY_DSN --serverName="keymaster-$BALENA_DEVICE_UUID"
